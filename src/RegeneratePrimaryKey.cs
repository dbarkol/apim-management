...
namespace Demo
{
    public static class RegeneratePrimaryKey
    {
        ...
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "regeneratePrimaryKey")] HttpRequest req,
            ILogger log)
        {
            log.LogInformation("Regenerate primary key triggered");
